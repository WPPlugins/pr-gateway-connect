...
?>
<div id="prgLogoLogin">
    <a target="_blank" href="http://www.pr-gateway.de"><img id="imgLargeLogin" class="prgLoginImg" src="<?php echo plugins_url('/images/pr-gateway_large1.png', dirname(__FILE__)); ?>"></a>
</div>
    ...
    <div id="rightLoginForm">
        <div class="form-group">
            <div class="col-md-12" id="divBtnRegister">
                <button class="btn btn-xs btn-primary" data-color="primary" type="button" onclick="window.open('http://prg.li/pr-gateway-connect-registration', 'Registrierung');">
