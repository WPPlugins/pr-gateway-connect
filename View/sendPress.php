...
<html>
    <head>
        ...
        <link rel = "stylesheet" id = "PRG-Form-css" href = "<?php echo plugins_url('css/prg_connect_form.1_0.css', dirname(__FILE__)); ?>" type = "text/css" media = "all">
        <script type = "text/javascript" src = "<?php echo plugins_url('js/jquery.min.1_7.js', dirname(__FILE__)); ?>"></script>
        <script type="text/javascript" src="<?php echo plugins_url('js/prg_connect_form.1_0.js', dirname(__FILE__)); ?>"></script>
        ...
        <form method="POST" id="prgConnect_sendPress" enctype="multipart/form-data">
            <fieldset>
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3>
                            <span class="label label-primary"><?php echo $text['WRITE_MSG']; ?></span>
                        </h3>
                    </div>
                    <div class="col-md-4">
                        <h3>
                            <span id="clientdata" class="label label-primary"><?php echo $text['GIVE_CONTACT']; ?></span>
                        </h3>
                    </div>
                </div>
                ...
                <div id="bottomPublishForm">
                    ...
                    <div id="submitDiv">
                        <button type="submit" name="draft" value="1" class="btn btn-success" id="submitDraft" data-color="primary"><?php echo $text['SAVE_MSG_DRAFT']; ?></button>
                        <button type="submit" name="publish" value="1" class="btn btn-success" data-color="primary"><?php echo $text['PUBLISH_MSG']; ?></button>
                    </div>
                </div>
            </fieldset>
            <div id="clearbot">
