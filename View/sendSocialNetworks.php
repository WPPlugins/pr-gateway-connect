...
//    require_once dirname(__FILE__) . '/../Controller/getWpImages.php';
...
<html>
    <head>
        ...
        <link rel="stylesheet" id="PRG-SN-Form-css"  href="<?php echo plugins_url('css/prg_connect_social_form.1_0.css', dirname(__FILE__)); ?>" type="text/css" media="all" />
        <script type="text/javascript" src="<?php echo plugins_url('js/jquery.min.1_7.js', dirname(__FILE__)); ?>"></script>
        <script type="text/javascript" src="<?php echo plugins_url('js/prg_connect_social_form.1_0.js', dirname(__FILE__)); ?>"></script>
                ...
                <fieldset>
                    <div id="facebookPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary"><input class="snChecks" <?php echo (empty($facebookName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkFacebook" type="checkbox" name="checkFacebook" />  Facebook</span>
                    ...
                    <div id="twitterPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary"><input class="snChecks" <?php echo (empty($twitterName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkTwitter" type="checkbox" name="checkTwitter" /> Twitter</span>
                    ...
                    <div id="linkedinPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary"><input class="snChecks" <?php echo (empty($linkedinName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkLinkedin" type="checkbox" name="checkLinkedin" /> LinkedIn</span>
                    ...
                    <div id="tumblrPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary"><input class="snChecks" <?php echo (empty($tumblrName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkTumblr" type="checkbox" name="checkTumblr"> Tumblr</span>
                    ...
                    <div id="storifyPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary"><input class="snChecks" <?php echo (empty($storifyName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkStorify" type="checkbox" name="checkStorify" /> Storify</span>
                    ...
                    <div id="pinterestPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary"><input class="snChecks" <?php echo (empty($pinterestName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkPinterest" type="checkbox" name="checkPinterest" /> Pinterest</span>
                    ...
                    <div id="flickrPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary"><input class="snChecks" <?php echo (empty($flickrName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkFlickr" type="checkbox" name="checkFlickr" /> Flickr</span>
                    ...
                    <div id="bottomPublishForm" class="hider">
                        <div id="imgChose" class="col-md-12">
                            <div class="col-md-12">
                                <h4>
                                    <span class="label label-primary"><?php echo $text['IMG_CHOOSE']; ?></span>
                    ...
                    <button id="btnSubmitSocial" class="btn btn-primary" data-color="primary"><?php echo $text['MSG_TO_SN'] ?></button>
                </fieldset>
