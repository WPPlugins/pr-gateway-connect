...
<div id="prgLogo">
    <a href="http://www.pr-gateway.de" target="_blank"><img id="imgLarge" src="<?php echo plugins_url('/images/pr-gateway_large1.png', dirname(__FILE__)); ?>"></a>
</div>
<div class="clear">
    ...
    <div id="configForm">
        <form method="POST" id="prg_cfgForm" class="form-horizontal">
            ...
            <span class="pull-right">
                <button id="btnSubmit" class="btn btn-primary" type="submit" data-color="primary"><?php echo $text['SAVE']; ?></button>
            </span>
        </form>
    </div>
</div>
